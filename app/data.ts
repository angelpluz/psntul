...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'A practical AI platform combining a local LLM chat interface, automation workflows, image-generation tooling, and data cleanup utilities for day-to-day internal operations.',
    longDescription: 'An AI-focused toolkit that brings together a terminal-style assistant UI, local model orchestration, content automation, and structured data cleanup into one maintainable internal platform.',
  ...
  },
  {
    ...
    description: 'Modernization of a legacy monolithic business system into a modular, API-driven architecture. Improved maintainability, deployment flexibility, and development velocity while preserving critical business logic.',
    longDescription: 'A controlled architectural modernization focused on incrementally refactoring a tightly coupled legacy system into a cleaner modular structure with API boundaries and clearer deployment practices.',
